 ...
 * riservato al caricamento/ricerca lista di contenuti.
 * @author E.Santoboni
 * @deprecated from jAPS 2.0 version 2.0.9. Use {@link IPublicContentSearcherDAO}
 */
public interface IContentSearcherDAO extends IEntitySearcherDAO {
	...
	/**
	 * @deprecated from jAPS 2.0 version 2.0.9. use constant on {@link IContentManager}
	 */
	public static final String DESCR_FILTER_KEY = IContentManager.CONTENT_DESCR_FILTER_KEY;
	
	/**
	 * @deprecated from jAPS 2.0 version 2.0.9. use constant on {@link IContentManager}
	 */
	public static final String STATUS_FILTER_KEY = IContentManager.CONTENT_STATUS_FILTER_KEY;
	
	/**
	 * @deprecated from jAPS 2.0 version 2.0.9. use constant on {@link IContentManager}
	 */
	public static final String CREATION_DATE_FILTER_KEY = IContentManager.CONTENT_CREATION_DATE_FILTER_KEY;
	
	/**
	 * @deprecated from jAPS 2.0 version 2.0.9. use constant on {@link IContentManager}
	 */
	public static final String MODIFY_DATE_FILTER_KEY = IContentManager.CONTENT_MODIFY_DATE_FILTER_KEY;
	
	/**
	 * @deprecated from jAPS 2.0 version 2.0.9. use constant on {@link IContentManager}
	 */
	public static final String ONLINE_FILTER_KEY = IContentManager.CONTENT_ONLINE_FILTER_KEY;
	
	/**
	 * @deprecated from jAPS 2.0 version 2.0.9. use constant on {@link IContentListHelper}
	 */
	public static final String[] allowedContentFilterKeys = IContentListHelper.allowedMetadataFilterKeys;
