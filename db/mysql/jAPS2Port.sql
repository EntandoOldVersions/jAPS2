...
--
-- Host: localhost    Database: jAPS2Port
-- ------------------------------------------------------
...
--
-- Current Database: `jAPS2Port`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `jAPS2Port` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `localstrings` VALUES ('ADMINISTRATION_BASIC','en','Normal'),('ADMINISTRATION_BASIC','it','Normale'),('ADMINISTRATION_BASIC_GOTO','en','Go to the administration with normal client'),('ADMINISTRATION_BASIC_GOTO','it','Accedi con client normale'),('ADMINISTRATION_MINT','en','Advanced'),('ADMINISTRATION_MINT','it','Avanzata'),('ADMINISTRATION_MINT_GOTO','en','Go to the administration with advanced client'),('ADMINISTRATION_MINT_GOTO','it','Accedi con client avanzato'),('ALL','en','All'),('ALL','it','Tutte'),('DATE_FROM','en','From'),('DATE_FROM','it','Da'),('DATE_TO','en','To'),('DATE_TO','it','A'),('GENERIC_ERROR','en','Generic Error'),('GENERIC_ERROR','it','Errore Generico'),('NUMBER_FROM','en','From'),('NUMBER_FROM','it','Da'),('NUMBER_TO','en','To'),('NUMBER_TO','it','A'),('PAGE','en','page'),('PAGE','it','pagina'),('PAGE_MODEL','en','page model'),('PAGE_MODEL','it','modello pagina'),('PAGE_NOT_FOUND','en','Page not found'),('PAGE_NOT_FOUND','it','Pagina non trovata'),('PAGE_TITLE','en','page title'),('PAGE_TITLE','it','titolo pagina'),('TEXT','en','Text'),('TEXT','it','Testo'),('USER_NOT_ALLOWED','en','User not allowed'),('USER_NOT_ALLOWED','it','Utente non autorizzato');
...
-- Dump completed on 2011-04-25 17:25:02
