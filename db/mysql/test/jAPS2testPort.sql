...
--
-- Create schema jAPS2testPort
--

CREATE DATABASE IF NOT EXISTS jAPS2testPort;
USE jAPS2testPort;

--
-- Definition of table `jAPS2testPort`.`categories`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`categories`;
CREATE TABLE  `jAPS2testPort`.`categories` (
...
--
-- Dumping data for table `jAPS2testPort`.`categories`
--

/*!40000 ALTER TABLE `categories` DISABLE KEYS */;
LOCK TABLES `categories` WRITE;
INSERT INTO `jAPS2testPort`.`categories` VALUES  ('Attach','resource_root','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<properties>\n<property key=\"it\">Attach</property>\n</properties>\n\n'),
...
--
-- Definition of table `jAPS2testPort`.`contentmodels`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`contentmodels`;
CREATE TABLE  `jAPS2testPort`.`contentmodels` (
...
--
-- Definition of table `jAPS2testPort`.`contentrelations`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`contentrelations`;
CREATE TABLE  `jAPS2testPort`.`contentrelations` (
...
--
-- Dumping data for table `jAPS2testPort`.`contentrelations`
--

/*!40000 ALTER TABLE `contentrelations` DISABLE KEYS */;
LOCK TABLES `contentrelations` WRITE;
INSERT INTO `jAPS2testPort`.`contentrelations` VALUES  ('RAH1',NULL,NULL,NULL,NULL,'free'),
...
--
-- Definition of table `jAPS2testPort`.`contents`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`contents`;
CREATE TABLE  `jAPS2testPort`.`contents` (
  `contentid` varchar(16) NOT NULL,
  `contenttype` varchar(30) NOT NULL,
...
--
-- Definition of table `jAPS2testPort`.`contentsearch`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`contentsearch`;
CREATE TABLE  `jAPS2testPort`.`contentsearch` (
  `contentid` varchar(16) NOT NULL,
...
--
-- Dumping data for table `jAPS2testPort`.`contentsearch`
--

/*!40000 ALTER TABLE `contentsearch` DISABLE KEYS */;
LOCK TABLES `contentsearch` WRITE;
INSERT INTO `jAPS2testPort`.`contentsearch` VALUES  ('ART120','Data',NULL,'2009-03-28',NULL,NULL),
...
--
-- Definition of table `jAPS2testPort`.`localstrings`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`localstrings`;
CREATE TABLE  `jAPS2testPort`.`localstrings` (
...
--
-- Dumping data for table `jAPS2testPort`.`localstrings`
--

/*!40000 ALTER TABLE `localstrings` DISABLE KEYS */;
LOCK TABLES `localstrings` WRITE;
INSERT INTO `jAPS2testPort`.`localstrings` VALUES  ('PAGE','en','page'),
 ('PAGE','it','pagina'),
...
--
-- Definition of table `jAPS2testPort`.`pagemodels`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`pagemodels`;
CREATE TABLE  `jAPS2testPort`.`pagemodels` (
...
--
-- Definition of table `jAPS2testPort`.`pages`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`pages`;
CREATE TABLE  `jAPS2testPort`.`pages` (
...
--
-- Dumping data for table `jAPS2testPort`.`pages`
--

/*!40000 ALTER TABLE `pages` DISABLE KEYS */;
LOCK TABLES `pages` WRITE;
INSERT INTO `jAPS2testPort`.`pages` VALUES  ('administrators_page','homepage',6,'home','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<properties>\n<property key=\"en\">Administrators Page</property>\n<property key=\"it\">Pagina gruppo Amministratori</property>\n</properties>','administrators',1,NULL),
...
--
-- Definition of table `jAPS2testPort`.`resourcerelations`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`resourcerelations`;
CREATE TABLE  `jAPS2testPort`.`resourcerelations` (
...
--
-- Dumping data for table `jAPS2testPort`.`resourcerelations`
--

/*!40000 ALTER TABLE `resourcerelations` DISABLE KEYS */;
LOCK TABLES `resourcerelations` WRITE;
INSERT INTO `jAPS2testPort`.`resourcerelations` VALUES  ('44','resource_root'),
 ('44','Image'),
 ('44','resCat1');
UNLOCK TABLES;
...
--
-- Definition of table `jAPS2testPort`.`resources`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`resources`;
CREATE TABLE  `jAPS2testPort`.`resources` (
  `resid` varchar(16) NOT NULL,
...
--
-- Definition of table `jAPS2testPort`.`showletcatalog`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`showletcatalog`;
CREATE TABLE  `jAPS2testPort`.`showletcatalog` (
  `code` varchar(40) NOT NULL,
  `titles` longtext NOT NULL,
  `parameters` longtext,
  `plugincode` varchar(30) DEFAULT NULL,
...
--
-- Definition of table `jAPS2testPort`.`showletconfig`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`showletconfig`;
CREATE TABLE  `jAPS2testPort`.`showletconfig` (
...
--
-- Dumping data for table `jAPS2testPort`.`showletconfig`
--

/*!40000 ALTER TABLE `showletconfig` DISABLE KEYS */;
LOCK TABLES `showletconfig` WRITE;
INSERT INTO `jAPS2testPort`.`showletconfig` VALUES  ('coach_page',2,'content_viewer','<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n<properties>\n<property key=\"contentId\">ART187</property>\n</properties>\n\n','ART187'),
...
--
-- Definition of table `jAPS2testPort`.`sysconfig`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`sysconfig`;
CREATE TABLE  `jAPS2testPort`.`sysconfig` (
...
--
-- Definition of table `jAPS2testPort`.`uniquekeys`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`uniquekeys`;
CREATE TABLE  `jAPS2testPort`.`uniquekeys` (
...
--
-- Dumping data for table `jAPS2testPort`.`uniquekeys`
--

/*!40000 ALTER TABLE `uniquekeys` DISABLE KEYS */;
LOCK TABLES `uniquekeys` WRITE;
INSERT INTO `jAPS2testPort`.`uniquekeys` VALUES  (1,200);
UNLOCK TABLES;
/*!40000 ALTER TABLE `uniquekeys` ENABLE KEYS */;


--
-- Definition of table `jAPS2testPort`.`workcontentrelations`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`workcontentrelations`;
CREATE TABLE  `jAPS2testPort`.`workcontentrelations` (
  `contentid` varchar(16) NOT NULL,
  `refcategory` varchar(30) DEFAULT NULL,
...
--
-- Dumping data for table `jAPS2testPort`.`workcontentrelations`
--

/*!40000 ALTER TABLE `workcontentrelations` DISABLE KEYS */;
LOCK TABLES `workcontentrelations` WRITE;
INSERT INTO `jAPS2testPort`.`workcontentrelations` VALUES  ('ART179','general'),
 ('ART179','general_cat1'),
 ('ART179','general_cat2'),
 ('ART180','cat1'),
 ('ART180','general'),
...
--
-- Definition of table `jAPS2testPort`.`workcontentsearch`
--

DROP TABLE IF EXISTS `jAPS2testPort`.`workcontentsearch`;
CREATE TABLE  `jAPS2testPort`.`workcontentsearch` (
...
--
-- Dumping data for table `jAPS2testPort`.`workcontentsearch`
--

/*!40000 ALTER TABLE `workcontentsearch` DISABLE KEYS */;
LOCK TABLES `workcontentsearch` WRITE;
INSERT INTO `jAPS2testPort`.`workcontentsearch` VALUES  ('ART120','Data',NULL,'2009-03-28',NULL,NULL),
 ('ART120','Numero',NULL,NULL,7,NULL),
