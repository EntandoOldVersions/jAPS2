...
<p>
	...
	<wpsf:submit action="configListViewer" value="%{getText('label.continue')}" cssClass="button" />	
</p>
</fieldset>
</s:if>
<s:else>
...
<p class="centerText"><wpsf:submit action="saveListViewerConfig" value="%{getText('label.save')}" cssClass="button" /></p>
