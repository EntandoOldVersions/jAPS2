...
<p><label for="contentType" class="basic-mint-label"><s:text name="label.type"/>:</label>
	...
	<wpsf:submit action="%{#changeContentTypeActionName}" cssClass="button" value="%{getText('label.set')}" />
<%--
	...
	<s:iterator var="attribute" value="#searcheableAttributes">
		...
		<s:if test="#attribute.textAttribute"> 
			<p>
				...
				<wpsf:textfield id="%{currentFieldId}" cssClass="text" name="%{#textInputFieldName}" value="%{getSearchFormFieldValue(#textInputFieldName)}" />
			</p>
		</s:if>
		...
		<s:elseif test="#attribute.type == 'Date'">
			...
			<p>
				...
				<wpsf:textfield id="%{currentFieldId}_dateStartFieldName_cal" cssClass="text" name="%{#dateStartInputFieldName}" value="%{getSearchFormFieldValue(#dateStartInputFieldName)}" /><span class="inlineNote">dd/MM/yyyy</span>
			</p>
			<p>
				...
				<wpsf:textfield id="%{currentFieldId}_dateEndFieldName_cal" cssClass="text" name="%{#dateEndInputFieldName}" value="%{getSearchFormFieldValue(#dateEndInputFieldName)}" /><span class="inlineNote">dd/MM/yyyy</span>
			</p>
		</s:elseif>
...
<p>
	...
	<wpsf:select name="ownerGroupName" id="ownerGroupName" list="#allowedGroupsVar" headerKey="" headerValue="%{getText('label.all')}" listKey="name" listValue="descr" cssClass="text" />
</p>
</s:if>
...
<ul class="radiocheck noBullet">
	<li><wpsf:checkbox name="viewCode" id="viewCode"></wpsf:checkbox><label for="viewCode"><s:text name="label.code"/></label></li>
	<li><wpsf:checkbox name="viewTypeDescr" id="viewTypeDescr"></wpsf:checkbox><label for="viewTypeDescr"><s:text name="name.contentType"/></label></li>
	<li><wpsf:checkbox name="viewStatus" id="viewStatus"></wpsf:checkbox><label for="viewStatus"><s:text name="name.contentStatus"/></label></li>
	<li><wpsf:checkbox name="viewGroup" id="viewGroup"></wpsf:checkbox><label for="viewGroup"><s:text name="label.group"/></label></li>
	<li><wpsf:checkbox name="viewCreationDate" id="viewCreationDate"></wpsf:checkbox><label for="viewCreationDate"><s:text name="label.creationDate"/></label></li>
</ul>
</div>
</fieldset>
...
<p>
	...
	<wpsf:submit action="%{#searchActionName}" value="%{getText('label.search')}" cssClass="button" /> 
</p>
