...
<fieldset class="margin-more-top"><legend><s:text name="label.info" /></legend>
	...
	<p>
		...
		<wpsf:textfield name="modelId" id="newModel_id" disabled="%{strutsAction == 2}" cssClass="text" />  
	</p>
	<p>
		<label for="newModel_contentType" class="basic-mint-label"><s:text name="contentModel.type" />:</label>
		<wpsf:select id="newModel_contentType" list="smallContentTypes" name="contentType" 
			listKey="code" listValue="descr" cssClass="text" />
			<wpsf:submit action="lockContentType" value="%{getText('label.set')}" cssClass="button" />
	</p> 
	<p>
	...
	<p>
		...
		<wpsf:textarea name="contentShape" id="newModel_contentShape" cols="60" rows="10" cssClass="text" />
