...
<div class="accordion_element">	
	...
	<p>
		...
		<wpsf:select name="contentType" id="contentType" list="contentTypes" listKey="code" listValue="descr" headerKey="" headerValue="%{getText('label.all')}" cssClass="text" />
	</p>
...
<p>
	<wpsf:checkbox name="contentOnPageType" id="contentOnPageType"/><label for="contentOnPageType"><s:text name="note.makeContentOnPageLink"></s:text></label>
</p>
