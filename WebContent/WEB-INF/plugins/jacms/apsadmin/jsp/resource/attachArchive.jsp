...
<dl class="gallery">
	...
	<dt class="image">
		<a href="<s:url action="joinResource" namespace="/do/jacms/Content/Resource">
			...
			</s:url>" title="<s:text name="note.joinThisToThat" />: <s:property value="content.descr" />" ><img src="<wp:resourceURL/>administration/common/img/icons/resourceTypes/<s:property value="%{getIconFile(#resourceInstance.fileName)}"/>" alt="<s:property value="%{#resourceInstance.fileName}"/>" title="<s:text name="note.joinThisToThat" />: <s:property value="content.descr" />" /></a><br /><s:property value="%{#resourceInstance.fileLength}"/></a>
	</dt>			
	</s:if>
	<s:else>
	<dt class="image"><img src="<wp:resourceURL/>administration/common/img/icons/resourceTypes/<s:property value="%{getIconFile(#resourceInstance.fileName)}"/>" alt="<s:property value="%{#resourceInstance.fileName}"/>" title="<s:property value="%{#resourceInstance.fileName}"/>" /><br /><s:property value="%{#resourceInstance.fileLength}"/></dt>
	</s:else>
	<dt class="options">
		<a href="<s:property value="%{#resource.documentPath}" />" title="<s:text name="label.download" />: <s:property value="#resource.descr" />"><s:text name="label.download" /></a>
		<s:if test="!onEditContent">
