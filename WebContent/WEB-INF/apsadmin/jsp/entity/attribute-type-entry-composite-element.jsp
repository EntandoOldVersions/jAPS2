...
<fieldset class="margin-more-top"><legend><s:text name="label.info" /></legend>
	<p>
		...
		<wpsf:textfield cssClass="text" id="attributeType" name="attributeType" value="%{attributeTypeCode}" disabled="true" />
	</p>
	<p>
		<label for="attributeName" class="basic-mint-label"><s:text name="label.code" />:</label>
		<wpsf:textfield name="attributeName" id="attributeName" cssClass="text"/> 
	</p>
