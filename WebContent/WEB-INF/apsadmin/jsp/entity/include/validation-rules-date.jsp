...
<fieldset><legend><s:text name="label.settings" /></legend>
	...
	<p>
		...
		<wpsf:textfield name="rangeStartDate" id="rangeStartDate_cal" value="%{#rangeStartDateValue}" cssClass="text"/><span class="inlineNote">dd/MM/yyyy</span>
	</p>
	...
	<p>
		...
		<wpsf:textfield name="rangeEndDate" id="rangeEndDate_cal" value="%{#rangeEndDateValue}" cssClass="text" /><span class="inlineNote">dd/MM/yyyy</span>
	</p>
	<s:if test="#sameAttributesList != null && #sameAttributesList.size() > 0">
	<p class="margin-more-bottom">
	...
	<p>
		...
		<wpsf:textfield name="equalDate" id="equalDate_cal" value="%{#equalDateValue}" cssClass="text" /><span class="inlineNote">dd/MM/yyyy</span>
	</p>
	<s:if test="#sameAttributesList != null && #sameAttributesList.size() > 0">
	<p>
