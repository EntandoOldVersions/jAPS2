...
<p>
	...
	<wpsf:textfield id="ognlValidationRule.expression" name="ognlValidationRule.expression" cssClass="text" />
</p>
...
<p>
	...
	<wpsf:textfield id="ognlValidationRule.helpMessage" name="ognlValidationRule.helpMessage" cssClass="text" />
</p>

<p>
	<label for="ognlValidationRule.helpMessageKey" class="basic-mint-label"><s:text name="name.helpMessage.key" />:</label>
	<wpsf:textfield id="ognlValidationRule.helpMessageKey" name="ognlValidationRule.helpMessageKey" cssClass="text" />
</p>

<p>
	<label for="ognlValidationRule.errorMessage" class="basic-mint-label"><s:text name="name.errorMessage.text" />:</label>
	<wpsf:textfield id="ognlValidationRule.errorMessage" name="ognlValidationRule.errorMessage" cssClass="text" />
</p>

<p>
	<label for="ognlValidationRule.errorMessageKey" class="basic-mint-label"><s:text name="name.errorMessage.key" />:</label>
	<wpsf:textfield id="ognlValidationRule.errorMessageKey" name="ognlValidationRule.errorMessageKey" cssClass="text" />
</p>
</div>
</fieldset>