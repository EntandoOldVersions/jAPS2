...
<fieldset class="margin-more-top"><legend><s:text name="label.info" /></legend>
	<p>
		...
		<wpsf:textfield cssClass="text" id="compositeAttribute.type" name="compositeAttribute.type" value="%{#compositeAttribute.type}" disabled="true" />
	</p>
...
<fieldset><legend><s:text name="label.attributes" /></legend>
	...
	<p>
		...
		<wpsf:select list="allowedAttributeElementTypes" id="attributeTypeCode" name="attributeTypeCode" listKey="type" listValue="type"/>
...
<p class="centerText">
	<wpsf:submit value="%{getText('label.save')}" action="saveCompositeAttribute" cssClass="button" />
</p>
