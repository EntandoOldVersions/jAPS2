...
<head>
	<title>jAPS 2.0 entando - Login</title>
...
<h1 class="raw centerText">jAPS 2.0 entando &ndash; <s:text name="title.login.intro" /></h1>
...
<fieldset id="fieldset_space"><legend><s:text name="login.authenticationInfo" /></legend>
	...
	<p class="centerText">
		...
		<!-- <wpsf:radio name="backend_client_gui" id="client-normal" value="normal" checked="true" /><label for="client-normal" class="right"><s:text name="name.client.basic" /></label><br />
		<wpsf:radio name="backend_client_gui" id="client-advanced" value="advanced" /><label for="client-advanced" class="right"><s:text name="name.client.mint" /></label> -->
	</p>
