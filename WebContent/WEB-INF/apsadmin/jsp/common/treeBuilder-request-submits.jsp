...
<wpsf:submit action="%{#openTreeAction}" type="image" src="%{#iconImagePath}" value="%{getText('label.open')}" title="%{getText('label.open')}" />
</s:if>
...
<wpsf:submit action="%{#closeTreeAction}" type="image" src="%{#iconImagePath}" value="%{getText('label.close')}" title="%{getText('label.close')}" />
</s:elseif>
