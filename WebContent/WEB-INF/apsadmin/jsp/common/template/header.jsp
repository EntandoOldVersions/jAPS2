...
<div id="header-2">
<p>
	<a class="noborder" href="http://www.japsportal.org/<s:property value="currentLang.code"/>/updates/" title="<s:text name="note.checkForUpdates" />">
		<img src="<wp:resourceURL/>administration/common/img/jAPS-2.0-logo.png" width="97" height="60" alt="jAPS 2.0" /> <span class="monospace version">version <wp:info key="systemParam" paramName="version" /></span>
	</a>
</p>
</div>
