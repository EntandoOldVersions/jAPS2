...
<s:set var="allowedShortcutsVar" value="allowedShortcuts"></s:set>
...
<h2 class="margin-bit-bottom" id="shortcut-configure"><s:text name="label.configure" />&#32;<s:text name="name.position" />&#32;<s:property value="%{position + 1}" /></h2>
...
<wpsf:submit value="%{getText('label.set')}" cssClass="button" />
</p>
</s:form>
</div>
</s:if>
