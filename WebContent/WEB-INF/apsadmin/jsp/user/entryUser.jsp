...
<p>
	<wpsf:checkbox name="active" id="active" cssClass="radiocheck" /><label for="active"><s:text name="note.userStatus.active" /></label>
</p>
</fieldset>
...
<p>
	<wpsf:checkbox name="reset" id="reset" cssClass="radiocheck" /><label for="reset"><s:text name="note.userStatus.reset" /></label>
</p>
