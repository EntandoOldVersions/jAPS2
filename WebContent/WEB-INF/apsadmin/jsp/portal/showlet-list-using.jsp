...
<h2 class="margin-more-bottom"><s:text name="title.showletManagement.pages" />: <s:property value="getTitle(#showletType.code, #showletType.titles)" /></h2>
		...
		<s:if test="#showlet != null && #showlet.type != null && #showlet.type.code.equals(showletTypeCode)">
			...
			<s:if test="%{isUserAllowed(#singlePage)}">
				<a class="noborder" href="<s:url action="trashShowletFromPage" namespace="/do/Portal/ShowletType">
					...
					<s:param name="showletTypeCode"><s:property value="#showletType.code"/></s:param>
				</s:url>
