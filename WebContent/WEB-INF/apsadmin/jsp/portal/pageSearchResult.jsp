...
<fieldset><legend><s:text name="title.pageManagement.pages" /></legend>
	...
	<s:iterator var="singlePage">
		...
		<li class="page tree_node_flag"><wpsf:radio name="selectedNode" id="page_%{#singlePage.code}" value="%{#singlePage.code}" /><label for="page_<s:property value="%{#singlePage.code}" />" title="<s:property value="#pageFullPath" />"><s:property value="%{#singlePage.code}" /></label></li>	
